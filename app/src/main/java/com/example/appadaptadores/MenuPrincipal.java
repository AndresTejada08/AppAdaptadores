...
import com.example.appadaptadores.Activitys.AgenciasActivity;
import com.example.appadaptadores.Activitys.DestinosActivity;
import com.example.appadaptadores.Activitys.HotelesActivity;
import com.example.appadaptadores.Activitys.RestaurantesActivity;
...
import com.example.appadaptadores.databinding.ActivityMenuPrincipalBinding;
...
public class MenuPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurant.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MenuPrincipal.this, RestaurantesActivity.class);
                startActivity(intent);
            }
        });
